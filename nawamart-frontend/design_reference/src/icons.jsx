// Shared Lucide-style icon set for NawaMart
// All icons stroke, 24x24 viewBox, currentColor
...
// Status badge shared
const STATUS_MAP = {
  pending:    { label: "بانتظار الوصل",  cls: "dk-badge-warning" },
  confirmed:  { label: "مؤكد",            cls: "dk-badge-success" },
  shipped:    { label: "تم الشحن",        cls: "dk-badge-info" },
  delivered:  { label: "تم التسليم",      cls: "dk-badge-delivered" },
  rejected:   { label: "مرفوض",            cls: "dk-badge-danger" },
  "chat-open":{ label: "محادثة مفتوحة",   cls: "dk-badge-info" },
  "digital-delivered":{ label: "تم التسليم", cls: "dk-badge-delivered" },
};

function StatusBadge({ status }) {
  const s = STATUS_MAP[status] || STATUS_MAP.pending;
  return <span className={`dk-badge ${s.cls}`}><span className="dot"/>{s.label}</span>;
}

Object.assign(window, { Icon, StatusBadge, STATUS_MAP });
