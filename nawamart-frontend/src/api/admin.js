...
export const toggleMerchantActive = (id) =>
  api.patch(`/admin/merchants/${id}/toggle-active`, {}, withAdminAuth())

export const getAdminStores = (params = {}) =>
  api.get('/admin/stores', withAdminAuth({ params }))

export const toggleStoreActive = (id) =>
  api.patch(`/admin/stores/${id}/toggle-active`, {}, withAdminAuth())
...
export const toggleCustomerActive = (id) =>
  api.patch(`/admin/customers/${id}/toggle-active`, {}, withAdminAuth())
